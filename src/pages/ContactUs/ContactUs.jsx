        ...
        <div className='h-[460px] py-12 bg-[rgba(255,255,255,0.8)]'>
            <div className='flex justify-center'>
                <div className='flex-1 pl-40'>
                    ...
                    <p className='mt-3 text-gray-500 text-md font-semibold'>Nirma University, Ahmedabad</p>
                    <p className='mt-3 text-gray-500 text-md font-semibold'><i className="text-indigo-400 fa-solid fa-envelope"></i> Email : <a href="" className='text-indigo-700 font-semibold'>farmeazy@gmail.com</a></p>
                </div>
                ...
                <div className='flex-1'>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="w-full mt-12 max-w-lg">
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full md:w-2/5 mr-3 border border-indigo-400 px-3 mb-6 md:mb-0">
                            ...
                            <div className="w-full md:w-2/5 ml-3 border border-indigo-400 px-3">
                            ...
                            <div className="w-full md:w-2/5 mt-3 mr-3 px-3 mb-6 border border-indigo-400 md:mb-0">
                            ...
                            <div className="w-full md:w-2/5 ml-3 mt-3 px-3 border border-indigo-400 mb-6 md:mb-0">
                            ...
                            <div className="w-full h-20 md:w-[450px] mt-3 mb-6 md:mb-0">
                                {/* <textarea onChange={(e) => setMessage(e.target.value)} value={message} className="form-control block w-full px-0.5 py-0.5 text-base font-normal text-gray-700 bg-white bg-clip-padding rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                    ...
                                    placeholder="Message*"
                                ></textarea> */}
                                <textarea rows={3} cols={10} type="text" name="phone_number" id="phone_number" autocomplete="given-number" class="mt-1 px-2 py-1 border border-indigo-400 outline-none block w-full shadow-sm sm:text-sm rounded-md" />
                            </div>
                            {done && (
                                <h1 style={{color: '#59b256', fontSize: '18px', marginTop: '12px'}}>Thank you, Your email has been sent</h1>
                            )}
                            <button className="px-6 py-1 rounded-lg mx-auto text-white text-xl font-semibold hover:bg-black bg-indigo-500">
                                Send Message
                            </button>

...
import { postLoginDataEmail, postLoginDataPhone, verifyOtpLogin } from "../../api/authAPI";
      ...
      >
        <div className="flex justify-center py-9 rounded-2xl">
          ...
          >
            <form
              onSubmit={Login}
              className="bg-gray-100 mx-auto relative p-9 pt-3 drop-shadow-md rounded-3xl flex flex-col justify-center text-center w-2/3"
            >
              ...
              />
              <button
                className="border-2 rounded-lg border-indigo-500 text-white hover:text-white hover:border-black transition bg-indigo-500 hover:bg-black font-bold py-1 px-8 mx-auto"
                type="submit"
              >
                Login
              </button>

        ...
        <div className="w-3/4 -translate-y-10 mx-auto">
          ...
          >
            ...
            <textarea
              ...
              className="shadow-inner border-none w-100 rounded-2xl placeholder:font-semibold placeholder:text-gray-400 placeholder:text-md input-style mb-3 p-3 h-32 "
            />
